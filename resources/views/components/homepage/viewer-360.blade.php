    ...
    <div class="order-2 lg:order-1">
        <div class="bg-black shadow-xl overflow-hidden h-screen w-screen relative">
            ...
            <div id="imageSlider" class="w-screen h-screen relative overflow-hidden">
                ...
                <!-- Left Arrow -->
                <button id="prevBtn"
                    class="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-2 border-white/70 bg-black/50 flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-300 z-20">
                ...
                <!-- Right Arrow -->
                <button id="nextBtn"
                    class="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full border-2 border-white/70 bg-black/50 flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-300 z-20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                ...
                <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-3 z-10">
                    <button
                        class="slider-dot w-3 h-3 rounded-full border-2 border-gray-500 bg-transparent transition-all duration-300"
                        data-index="0"></button>
                    <button
                        class="slider-dot w-3 h-3 rounded-full border-2 border-gray-500 bg-gray-500 transition-all duration-300"
                        data-index="1"></button>
                    <button
                        class="slider-dot w-3 h-3 rounded-full border-2 border-gray-500 bg-transparent transition-all duration-300"
                        data-index="2"></button>
